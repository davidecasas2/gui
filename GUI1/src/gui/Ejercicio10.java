...
public class Ejercicio10 extends JFrame {
	...
	private final double dolarAEuro= 0.8989;
	private final double dolarAYen=115.66;
	private final double euroaADolar=1.1131;
	private final double euroAYen=128.75;
	private final double yenaADolar=0.008645;
	private final double yenAEuro=0.0077;
